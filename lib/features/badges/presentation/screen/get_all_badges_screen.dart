...
import 'package:flutter/material.dart';
import 'package:flutter_ursffiver/features/badges/controller/give_badge_controller.dart';
import 'package:flutter_ursffiver/features/badges/presentation/widget/all_badges_record_widget.dart';
import 'package:get/get.dart';
import '../../../../core/theme/app_colors.dart';
import '../../../../core/theme/app_gap.dart';
...
class _GetAllBadgesScreenState extends State<GetAllBadgesScreen> {
  late AllBadgesController2 badgeController;
  String? selectedBadgeId;

  @override
  void initState() {
    super.initState();
    badgeController = Get.put(AllBadgesController2());
  }
              ...
              SizedBox(
                ...
                child: Obx(() {
                  return ElevatedButton(
                    onPressed: selectedBadgeId != null &&
                            !badgeController.isLoading.value
                        ? () async {
                            await badgeController.giveBadge(
                    ...
                    child: badgeController.isLoading.value
                        ? const CircularProgressIndicator(color: Colors.white)
                        : Text("Send Badge",
                            style: AppText.mdMedium_16_500
