...
//   String originalEmail = "hello@example.com"; // store verified email
//   File? _profileImage;
...
//     setState(() {
//       isEditing = false;
//       originalEmail = emailController.text; // after save → new email is verified
//     });
...
//     // Check verification dynamically
//     bool emailChanged = emailController.text != originalEmail;
//     bool showVerified = !emailChanged;
...
//                   color: AppColors.primarybutton, fontSize: 16),
//             ),
//           ),
//         ],
//       ),
...
//             // First and Last Name (always disabled)
...
//             // Email with dynamic verification state
...
//       {String? helperText, bool alwaysDisabled = false}) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text(label,
