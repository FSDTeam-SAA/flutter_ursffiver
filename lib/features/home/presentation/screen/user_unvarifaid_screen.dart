...
//                       ),
//                     ),
//                     hint: const Text("Choose your identification document"),
//                     items: const [
//                       DropdownMenuItem(
//                           value: "passport", child: Text("Passport")),
//                       DropdownMenuItem(
//                           value: "nid", child: Text("National ID Card")),
//                       DropdownMenuItem(
...
//                         fileName = null; // reset file when changing type
//                       });
//                     },
//                   ),
...
//                   // Upload box (only for passport or NID)
//                   if (selectedDocument == "passport" ||
//                       selectedDocument == "nid") ...[
//                     Container(
//                       width: double.infinity,
//                       padding: const EdgeInsets.all(16),
//                       child: Column(
