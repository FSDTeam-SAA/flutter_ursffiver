            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("Yours truly Local", style: TextStyle(fontSize: 16)),
                  ...
                  _RulesBox(
                    checks: {
                      ...
                      _hasUppercase(_password.text),
                      'At least 1 lowercase letter':
                      _hasLowercase(_password.text),
                      'At least 1 number': _hasNumber(_password.text),
                      'At least 1 special character (e.g., !@#\$%)':
                      _hasSpecial(_password.text),
                    },
            ...
            children: [
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  color: Colors.white,
                  border: Border(
                    top: BorderSide(color: Color(0xFFE6E6E9)),
                  ),
                ),
                child: Column(
                    ...
                    Row(
                      children: [
                        ...
                        if (_selected.isEmpty)
                          const Text("Please select at least 1",
                              style: TextStyle(color: Colors.red)),
                      ],
                    ),
                    const SizedBox(height: 8),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText:
                      "Brief description (optional, max 100 chars)",
                      border: OutlineInputBorder(),
                    ),
                  ),
                  const SizedBox(height: 12),
                ...
                Expanded(
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: valid ? Colors.green : Colors.black87,
                      fontWeight:
                      valid ? FontWeight.w600 : FontWeight.normal,
                    ),
                  ),
                ),
              ],
